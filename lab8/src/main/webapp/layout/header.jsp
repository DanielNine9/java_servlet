...
<nav class="container navbar navbar-expand-lg bg-body-tertiary">
	<div class="container-fluid">
		<a class="navbar-brand" href="#">Java 4 ${sessionScope.lang}</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/lab8/home/gioi-thieu"><fmt:message
							key="menu.about" /></a></li>

				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/lab8/home/lien-he"><fmt:message
							key="menu.contact" /></a></li>

				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/lab8/bai2/home">Bai 2</a></li>
