	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (uri.contains("edit")) {
			...
			try {
				...
				if (EntityName != null) {
					req.setAttribute("message", "EntityNamename đã tồn tại.");
				...
				BeanUtils.populate(EntityName, req.getParameterMap());

				EntityName createdEntityName = dao.create(EntityName);

				if (createdEntityName != null) {
					EntityName = null;
		...
		req.setAttribute("form", EntityName);
		req.setAttribute("items", dao.findAll(page, pageSize));
